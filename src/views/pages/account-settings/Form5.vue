    ...
    ExportFile() {
        ...
        const tr = new TableRow({
          children: [
            new TableCell({
              ...
              children: [new Paragraph({ text: new Date(i.date).toLocaleString('ru', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })})],
      ...
      doc.addSection({
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({text: `2.3. Договор заключается на срок до ${new Date(this.dateRange).toLocaleString('ru', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
          ...
          new Paragraph({
            alignment: AlignmentType.CENTER,
            children: [
              new TextRun({text: `3. ПРАВА И ОБЯЗАННОСТИ СТОРОН`, break: 1 , bold: true, allCaps: true})
            ]
          }),
          new Paragraph({
            children: [
          ...
          new Paragraph({
            alignment: AlignmentType.CENTER,
            children: [
              new TextRun({text: `7. ПОДПИСИ СТОРОН` , bold: true, allCaps: true, break: 1})
            ]
          }),
          new Paragraph({
            children: [
